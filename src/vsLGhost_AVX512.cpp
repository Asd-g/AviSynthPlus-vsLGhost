...
void vsLGhost::filter_avx512(PVideoFrame& src, PVideoFrame& dst, const vsLGhost* const __restrict, IScriptEnvironment* env) noexcept
{
...
template void vsLGhost::filter_avx512<uint8_t>(PVideoFrame& src, PVideoFrame& dst, const vsLGhost* const __restrict, IScriptEnvironment* env) noexcept;
template void vsLGhost::filter_avx512<uint16_t>(PVideoFrame& src, PVideoFrame& dst, const vsLGhost* const __restrict, IScriptEnvironment* env) noexcept;
template void vsLGhost::filter_avx512<float>(PVideoFrame& src, PVideoFrame& dst, const vsLGhost* const __restrict, IScriptEnvironment* env) noexcept;
